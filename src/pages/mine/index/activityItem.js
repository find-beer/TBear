    ...
    return (
      <View style={styles.dynamicItemWrap}>
        <View style={styles.itemHeader}>
          <Image
            source={{
              uri: get(item.userVO, 'pic', '')?.replace('https', 'http'),
            }}
          ...
          <View style={styles.dynamicInfo}>
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoPosition}>{item.cityName || '北京'}</Text>
        ...
        <View style={styles.operationBox}>
          ...
          <View style={styles.oerationItem}>
            <Image source={imageUrl.join} style={styles.operationIcon} />
            <Text style={styles.operationText}>
              已加入{item.ticketVoList?.assembleMemberCount || 0}人
            </Text>
          </View>
          <View style={styles.oerationItem}>
